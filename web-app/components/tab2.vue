...
export default {
  head() {
    return {
      script: [{ src: "https://ueeil.github.io/uebung/model.js", body: true, defer: true }] //type: "text/javascript"
    };
  },
  data() {
    return {
  ...
  methods: {
    ...
    addItemToTimeframe() {
      ...
      if (now - this.lastTimeframeTickTime >= 3000) {
        ...
        this.currentPrediction = this.execute(this.currentFeatures);
